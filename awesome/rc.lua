...
-- {{{ Wallpaper
if beautiful.wallpaper then awful.util.spawn(beautiful.wallpaper) end
-- }}}
...
for s = 1, screen.count() do
    ...
    --if s == 1 then right_layout.add(mymemwig) end
    --if s == 1 then right_layout.add(myseparator) end
    --if s == 1 then right_layout.add(mycpuwig) end
    --if s == 1 then right_layout.add(myseparator) end
